	...
	render: function() {
		return (
			<div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				...
				/>
				<label className="mdl-textfield__label" htmlFor="search-field">
	...
	render: function() {
		...
		return (
			<tr
				...
				className={cn}
				onClick={this.select}>
				<td className="mdl-data-table__cell--non-numeric">{this.props.member}</td>
				<td className="mdl-data-table__cell--non-numeric">{this.props.path}</td>
			</tr>
		);
	}
});
...
var SearchResults = React.createClass({
	...
	render: function() {
		...
		return (
			<div id="search-results" style={{display: d}}>
